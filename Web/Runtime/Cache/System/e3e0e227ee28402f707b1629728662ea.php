...
<head>
	<title>Present by vmuui.com 管理中心 - 新闻列表</title>
...
var	myGridnum=6, //选中框所在的下标
	...
	myGrid.setHeader("ID,新闻标题,浏览次数,发布时间,启用,编辑,<a href='javascript:void(0)' onclick='chk_all()'>全选 </a>");
	myGrid.setInitWidths("80,*,120,160,80,80,80");
	myGrid.setColAlign("center,left,center,center,center,center,center");
	myGrid.setColTypes("ro,ed,ro,ro,ch,link,ch");
