...
<div class="tab_tit">修改案例</div>
    ...
    <tr>
		...
		<td  align="left" style="height:86px"><div class="vmupload" style="<?php if(empty($info['img'])): else: ?>background:none<?php endif; ?>">
        ...
        <div class="vmimgdesc">1、图片为通用案例图片，大小：450*310<br>2、前台显示的效果是预览框的等比缩放图<br>3、推荐上传指定大小的图片</div></td>
    </tr>
    <tr>
